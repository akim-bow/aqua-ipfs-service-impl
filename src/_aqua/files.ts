                    ...
                    (xor
                     (seq
                      (seq
                       ...
                       (call %init_peer_id% ("ipfs client" "exists") [multiaddr cid] exists)
                      )
                      (xor
                       (call %init_peer_id% ("callbackSrv" "response") [exists])
                    ...
                    (xor
                     (seq
                      (seq
                       ...
                       (call %init_peer_id% ("ipfs client" "upload_string") [ipfs path] upload_string)
                      )
                      (xor
